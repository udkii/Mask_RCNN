...
class ScaffoldDataset(utils.Dataset):
    def load_coco(self, dataset_dir, subset, year=DEFAULT_DATASET_YEAR, class_ids=None,
        ...
        coco = COCO("{}/{}/JPEGImages/annotations.json".format(dataset_dir, subset))
    ...
    def load_mask(self, image_id):
        ...
        if image_info["source"] != "coco":
            return super(ScaffoldDataset, self).load_mask(image_id)
        ...
        if class_ids:
#nh_edit_220222_for erase np.bool 
#            mask = np.stack(instance_masks, axis=2).astype(np.bool)
    ...
    def image_reference(self, image_id):
        ...
        if info["source"] == "coco":
            ...
            super(ScaffoldDataset, self).image_reference(image_id)
