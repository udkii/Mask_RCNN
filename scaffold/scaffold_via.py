...
'''
    def load_scaffold(self, dataset_dir, subset):
        ...
        self.add_class("scaffold", 3, "basejack")
        self.add_class("scaffold", 4, "platform")
        self.add_class("scaffold", 5, "stairs")
        ...
        for a in annotations:
            ...
            objects = [s['shape_attributes'] for s in a ['regions']]
...
#                print n
                try :
                    if n['scaffold'] == 'vertical':
                        num_ids.append(1)
                    elif n['scaffold'] == 'guard':
                        num_ids.append(2)
                    elif n['scaffold'] == 'basejack':
                        num_ids.append(3)
                    elif n['scaffold'] == 'platform':
                        num_ids.append(4)
                    elif n['scaffold'] == 'stairs':
                        num_ids.append(5)
                except:
                    pass
